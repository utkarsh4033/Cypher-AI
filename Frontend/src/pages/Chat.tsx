...
const Chat = () => {
  ...
  useLayoutEffect(() => {
    if (auth?.isLoggedIn && auth.user) {
      toast.loading("Loading cahst", { id: "loadchats" });
      getUserChats()
        .then((data) => {
      ...
      >
        ...
        >
          ...
          <Typography sx={{ mx: "auto", fontFamily: "poppins", my: 4, p: 3 }}>
            you can ask me some quesationsrelated to education, Businedd,
            advices, etc. But avoid sharing personal detils and confidential
            data.
          </Typography>
          <Button
            onClick={hanleDeleteChats}
            sx={{
              width: "200px",
              my: "auto",
              color: "white",
